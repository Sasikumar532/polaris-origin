...
// The gold/white logo variant (white "POLARIS" + gold "ORIGIN" + gold mark),
// hosted from /public so email clients can load it from a stable HTTPS URL.
// Its white text needs a dark background — it sits directly on the navy
// header band, no wrapper card needed.
const LOGO_URL = `${SITE_URL}/logo-golden.png`;
